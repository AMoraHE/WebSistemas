  ...
  <!------------------------------------------------------------- INFORMACIÓN ---------------------------------------------------------->
      ...
      @endif
  		...
  		<div class="contenedor-botones">
  			...
  			<a onclick="return confirm('¿Desea guardar el nuevo elemento?')" href="/Img-Lab-Micro-Registrar"><button class="btn guardar" type="submit"><span>Guardar</span></button></a>
...
<!------------------------------------------------------------- PREVISUALIZACIÓN ---------------------------------------------------------->
      ...
      <a onclick="return confirm('¿Desea regresar al menú anterior?')" href="/Lab-Micro"><button type="button" class="btn finalizar"><span>Finalizar</span></button></a>
