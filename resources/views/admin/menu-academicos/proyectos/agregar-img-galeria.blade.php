...
<div class="seccion-principal">
  ...
  <!------------------------------------------------------------- INFORMACIÓN ---------------------------------------------------------->
      ...
      <form id="formulario" class="form-group" files = "true" method="POST" action="/ProyectosAcademicosGaleria" enctype="multipart/form-data">
        @csrf
...
<!------------------------------------------------------------- PREVISUALIZACIÓN ---------------------------------------------------------->
      ...
      <a class="msj" mesanje="finalizar?" href="/ProyectosAcademicos"><button type="button" class="btn finalizar"><span>Finalizar</span></button></a>
