...
class LabCiscoController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $imagenes = DB::table('imagen_labs')->join('infraestructuras', 'imagen_labs.lab_id', '=', 'infraestructuras.slug')->where('infraestructuras.slug', 'cisco')->select('imagen_labs.*')->get();

        return view('/admin/menu-inf/lab-cisco/show', compact('infras', 'imagenes'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('/Lab-Cisco')->with('status','Eliminación Exitosa');
    }
}
